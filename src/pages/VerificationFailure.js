...
function EnrollmentReport() {
    ...
    useEffect(() => {
        const fetchData = () => {
            ...
            fetch("https://kaizenvoiz.ai/dashboardwebapi/api/Dashboard/overall-checkin-failed-report")
                .then((res) => res.json())
                .then((raw) => {
    ...
    const downloadCSV = (heading) => {
        ...
        const rows = [];
        rows.push(["VERIFICATION FAILURE"]);
        rows.push([]);
        rows.push(header);
        ...
        saveAs(blob, `Verification failure.csv`);
    };
    ...
    const downloadExcel = async (heading) => {
        ...
        titleCell.value = heading || "Verification Failure";
        ...
        saveAs(blob, `Verification failure.xlsx`);
    };
    // Pagination logic
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        <span title="Download CSV">
                            <i
                                ...
                                style={{ cursor: "pointer" }}
                                onClick={() => downloadCSV("Verification Failure")}
                            ></i>
                        </span>
                    </div>
                </div>
