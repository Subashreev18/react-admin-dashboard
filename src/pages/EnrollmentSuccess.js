...
function EnrollmentReport() {
    ...
    const downloadCSV = (heading) => {
        ...
        saveAs(blob, `Enrollment success.csv`);
    };
    ...
    const downloadExcel = async (heading) => {
        ...
        titleCell.value = heading || "Enrollment Success";
        ...
        saveAs(blob, `Enrollment success.xlsx`);
    };
                    ...
                    <div className="d-flex align-items-center">
                        ...
                        <span title="Download CSV">
                            <i
                                ...
                                style={{ cursor: "pointer" }}
                                onClick={() => downloadCSV("Enrollment Success")}
                            ></i>
                        </span>
                    </div>
                    ...
                    <div className="mb-4">
                        ...
                        >
                            {filteredData.slice(0, 10).map((row, index) => (
                                <div key={index} className="p-1"> {/* reduced outer padding */}
                                    <div
                                ...
                                {currentData.length > 0 ? (
                                    currentData.map((row, index) => (
                                        <tr key={index}>
                                            ...
                                            <td
                                                className={`fw-bold text-center ${row.status === "Success" ? "text-success" : "text-danger"
                                                    }`}
                                            >
                                                {row.status}
                                            </td>
